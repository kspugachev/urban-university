...
if response.status_code == 200:  # Проверка успешности запроса.
	...
	usd_change = data['cbrf']['data'][0][4]  # Индекс 4 соответствует 'CBRF_USD_LASTCHANGEPRCNT' (величина изменения).
	...
	eur_change = data['cbrf']['data'][0][7]  # Индекс 7 соответствует 'CBRF_EUR_LASTCHANGEPRCNT' (величина изменения).
